        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:gap-16">
          <Reveal>
            ...
            <p className="mt-5 max-w-prose text-sm leading-relaxed text-muted-foreground sm:text-base">
              ...
              somewhere: a sensor feeding a live dashboard, a scan report that had to be readable,
              a static tool that had to work on a phone. I care about the part after the demo —
            ...
            <p className="mt-5 max-w-prose text-sm leading-relaxed text-muted-foreground sm:text-base">
              ...
              design, containers and orchestration, pipelines, and the observability layer that
